...
curs.execute('''DELETE FROM student WHERE core = 'Core?';''')
conn.commit()
...
with codecs.open("../evaluation/db/directory_tab.csv", "r+", "UTF-8") as infile:
    ...
    to_db = [(i['Last_name'], i['first_name'], i['middle_name'], i['UID'],\
        ...
        i['program_code'], i['advisor'], i['street1'], i['street2'],\
        i['street3'], i['city'], i['state'], i['zip'], i['country'],\
        i['degree_name'], i['Applicants_only_GRE_v'],\
        i['Applicants_only_GRE_a'], i['Applicants_only_GRE_q'],\
        i['Applicants_only_GRE_v_percentile'],\
        i['Applicants_only_GRE_a_percentile'],\
        i['Applicants_only_GRE_q_percentile'], i['Applicants_only_rating'],\
        i['Applicants_only_TWE'], i['Applicants_only_TOEFL'],\
        i['Applicants_only_GMAT'], i['Applicants_only_MAT_Miller'],\
        i['Applicants_only_MAT_New_Miller_New_Score_range'],\
        i['Applicants_only_LSAT'], i['Certification_if_applicable'],\
        i['Special_Program_if_applicable'],\
        i['Applicants_only_GRE_Subject_Score'],\
        i['Applicants_only_GRE_Subject_Percentile'],\
        i['Applicants_only_GRE_Subject_Name'],\
        i['Applicants_only_Dept_Admission_Dec'],\
        i['Applicants_only_GS_Admission_Dec'],\
        i['Applicants_only_Dept_provision_codes'],\
        i['Applicants_only_GS_provision_codes'],\
        i['Applicants_only_GPA_Undergrad'],\
        i['Home_Phone'], i['Work_Phone'], i['Is_International'],\
        i['Applicants_only_ASF_Submit'],\
        i['Applicants_only_Recommendation_1_Name'],\
        i['Applicants_only_Recommendation_1_Received'],\
        i['Applicants_only_Recommendation_2_Name'],\
        i['Applicants_only_Recommendation_2_Received'],\
        i['Applicants_only_Recommendation_3_Name'],\
        i['Applicants_only_Recommendation_3_Received'],\
        i['Local_address_street1'], i['Local_address_street2'],\
        i['Local_address_street3'], i['Local_address_city'],\
        i['Local_address_state'], i['Local_address_zip'],\
        i['Local_address_country'],\
        i['Applicants_only_Num_Publications'],\
        i['Last_Undergrad_Univ_code'],\
        i['Applicants_only_Last_Undergrad_univs_Tier'],\
        i['Last_Undergrad_univs_Long_Name'],\
        i['Applicants_only_Last_Undergrad_univs_ASF_entered_GPA'],\
        i['Applicants_only_Last_Undergrad_Univ_ASF_entered_Major_Department'],\
        i['Applicants_only_Last_Undergrad_if_available_Transcript_Received'],\
        i['Applicants_only_Last_Graduate_Univ_code'],\
        i['Applicants_only_Last_Graduate_univs_Tier'],\
        i['Applicants_only_Last_Graduate_univs_Long_Name'],\
        i['Applicants_only_Last_Graduate_univs_ASF_entered_GPA'],\
        i['Applicants_only_Last_Graduate_Univ_ASF_entered_Major_Department'],\
        i['Applicants_only_Last_Graduate_if_available_Transcript_Received'],\
        i['Applicants_only_Research_Interest_1'],\
        i['Applicants_only_Research_Interest_2'],\
        i['Applicants_only_Research_Interest_3'],\
        i['Applicants_only_Research_Interest_4'],\
        i['visa'], i['sex'], i['race'], i['citizenship'],\
        i['Applicants_only_Interview_Audition_Scheduled_Date'],\
        i['Applicants_only_Interview_Audition_Scheduled_Location'],\
        i['Applicants_only_Interview_Audition_Primary_Request_Date'],\
        i['Applicants_only_Interview_Audition_Secondary_Request_Date'],\
        i['Applicants_only_ASF_Checkbox_reponse'],\
        i['Applicants_only_ASF_TextBox_1_reponse'],\
        i['Applicants_only_ASF_TextBox_2_reponse'],\
        i['Applicants_only_ASF_TextBox_3_reponse'],\
        i['Applicants_only_ASF_TextBox_4_reponse'],\
        i['Applicants_only_ASF_TextBox_5_reponse'],\
        i['Minor'], i['Hometown'], i['hobbies'],\
        i['Buckley_Confidentiality_Code'], i['Birthday'],\
        i['Applicants_only_Evaluations_1'],\
        i['Applicants_only_Evaluations_2'],\
        i['Applicants_only_Evaluations_3'],\
        i['Applicants_only_Evaluations_4'],\
        i['Applicants_only_Evaluations_5'],\
        i['Applicants_only_Evaluations_6'],\
        i['Applicants_only_Evaluations_7'],\
        i['Applicants_only_Evaluations_8'],\
        i['Applicants_only_Evaluations_9'],\
        i['Applicants_only_Evaluations_10'],\
        i['Applicants_only_Evaluations_11'],\
        i['Applicants_only_Evaluations_12'],\
        i['Applicants_only_Evaluations_13'],\
        i['Applicants_only_Evaluations_14'],\
        i['Applicants_only_Aid_Request'],\
        i['Financial_Aid_this_sem_1_Semester'],\
        i['Financial_Aid_this_sem_1_Department_offering'],\
        i['Financial_Aid_this_sem_1_PHR_ID'],\
        i['Financial_Aid_this_sem_1_Type'],\
        i['Financial_Aid_this_sem_2_Semester'],\
        i['Financial_Aid_this_sem_2_Department_offering'],\
        i['Financial_Aid_this_sem_2_PHR_ID'],\
        i['Financial_Aid_this_sem_2_Type'], i['forFuture1'],\
        i['forFuture2'], i['forFuture3'],\
        i['forFuture4'], i['forFuture5'], i['forFuture6'],\
        i['forFuture7'], i['forFuture8'], i['forFuture9'],\
        i['forFuture10'], i['forFuture11'], i['forFuture12'],\
        i['forFuture13'], i['forFuture14'], i['forFuture15'],\
        i['forFuture16']) for i in dr]
...
qry_insert_directory = '''INSERT INTO directory ( 
    ...
    Applicants_only_GRE_Subject_Score,  
